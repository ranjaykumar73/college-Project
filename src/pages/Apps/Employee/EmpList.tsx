                    ...
                    <DataTable
                        ...
                        columns={[
                            ...
                            },
                            {
                                ...
                                title: 'designation',
                                sortable: true,
                                render: ({ designation }) => <div className="text-center font-semibold">{`${designation}`}</div>,
                            },
                           ...
                           
                            {
                                ...
                                render: ({ id }) => (
                                    <div className="flex gap-4 items-center w-max mx-auto">
                                        ...
                                        <Tippy content="Edit">
                                            <NavLink to="/apps/employeeEdit" className="flex hover:text-info">
                                                <IconEdit className="w-4.5 h-4.5" />
                                            </NavLink>
                                        </Tippy>

                                        <Tippy content="Preview">
                                            <NavLink to="/apps/StaffProfile" className="flex hover:text-primary">
                                                <IconEye />
                                            </NavLink>
                                        </Tippy>

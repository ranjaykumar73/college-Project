...
import EmpPreview1 from './EmpPreview1';
import PayrollProfile from '../Payroll/PayrollProfile';
import LeaveProfile from '../LeaveType/LeaveProfile';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-5 mb-5">
                    <div className="panel ">
                        <div className="flex items-center justify-between mb-5">
                            ...
                            <Link to="/apps/employeeEdit" className="ltr:ml-auto rtl:mr-auto btn btn-primary p-2 rounded-full">
                                <IconPencilPaper />
                            </Link>
                        </div>
                        <div className="mb-5">
                            <div className="flex flex-row items-start">
                                ...
                                <div className="flex flex-col items-start justify-center pl-4 pt-2">
                                    <p className="font-semibold text-primary text-xl pb-2">Joe Black</p>
                                    <li className="flex items-center gap-2"> Staff ID:&nbsp; 2140 </li>
                                    <li className="flex items-center gap-2 "> Role:&nbsp; Super Admin</li>
                                </div>
                            </div>
                            <ul className="mt-5 flex flex-col max-w-[250px] m-auto space-y-4 font-semibold text-white-dark">
                                ...
                                <div className="flex flex-row justify-between">
                                    <li className="flex items-start "> Designation&nbsp;:</li>
                                    <li className="flex flex-row ">Technical Head</li>
                                </div>
                                <div className="flex flex-row justify-between">
                                    <li className="flex items-start "> Department&nbsp;:</li>
                                    <li className="flex flex-row "> Admin</li>
                                </div>
                                <div className="flex flex-row justify-between">
                                    <li className="flex items-start "> EPF No.&nbsp;:</li>
                                    <li className="flex flex-row "> 564564564</li>
                                </div>
                                <div className="flex flex-row justify-between">
                                    <li className="flex items-start "> Basic Salary&nbsp;:</li>
                                    <li className="flex flex-row "> 45,000.00</li>
                                </div>
                                <div className="flex flex-row justify-between">
                                    <li className="flex items-start "> Contract Type&nbsp;:</li>
                                    <li className="flex flex-row ">Permanent</li>
                                </div>
                                {/* <div className="flex flex-row justify-between">
                                    <li className="flex items-start "> Work Shift&nbsp;:</li>
                                    <li className="flex flex-row ">Morning</li>
                                </div> */}
                                {/* <div className="flex flex-row justify-between">
                                    <li className="flex items-start "> Work Location&nbsp;:</li>
                                    <li className="flex flex-row ">Ground Floor</li>
                                </div> */}
                                <div className="flex flex-row justify-between">
                                    <li className="flex items-start ">Date Of Joining&nbsp;:</li>
                                    <li className="flex flex-row ">03/11/2010</li>
                                </div>
                                <div className="flex flex-row justify-between">

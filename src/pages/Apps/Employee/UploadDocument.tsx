...
const UploadDocument = ({ nextHandler, backHandler }) => {
    ...
    function submitForm(values: FormValues) {
       ...
       // if (isConfirmed) {
            ...
            nextHandler();
            showAlert(1);
            navigate('/apps/employeelist', { state: { showAlert: true } });
                                    ...
                                    <div className="flex justify-evenly mt-5 lg:flex-row flex-col gap-4">
                                        <div>
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <Field type="file" id="resume" name="resume" accept="image/png, image/jpeg, .pdf" className="form-input file:py-2 file:px-4 file:border-0 file:font-semibold p-0 file:bg-primary/90 ltr:file:mr-5 rtl:file-ml-5 file:text-white file:hover:bg-primary " />
                                        ...
                                        <div>
                                            ...
                                            <div className="flex-1">
                                                <p className="text-gray-400">only upload pdf,jpeg,png file</p>
                                                <Field type="file" id="joinig_letter" name="joinig_letter" accept="image/png, image/jpeg, .pdf" className="form-input file:py-2 file:px-4 file:border-0 file:font-semibold p-0 file:bg-primary/90 ltr:file:mr-5 rtl:file-ml-5 file:text-white file:hover:bg-primary" />
                                        ...
                                        <div>
                                            ...
                                            <div className="flex-1">
                                                <p className="text-gray-400">only upload pdf,jpeg,png file</p>
                                                <Field type="file" id="resignation_letter" name="resignation_letter" accept="image/png, image/jpeg, .pdf" className="form-input file:py-2 file:px-4 file:border-0 file:font-semibold p-0 file:bg-primary/90 ltr:file:mr-5 rtl:file-ml-5 file:text-white file:hover:bg-primary " />
                                        ...
                                        <div>
                                            ...
                                            <div className="flex-1">
                                                <p className="text-gray-400">only upload pdf,jpeg,png file</p>
                                                <Field type="file" id="other_document" name="other_document" accept="image/png, image/jpeg, .pdf" className="form-input file:py-2 file:px-4 file:border-0 file:font-semibold p-0 file:bg-primary/90 ltr:file:mr-5 rtl:file-ml-5 file:text-white file:hover:bg-primary" />

...
const sampleDate: SampleData[] =  [
    {
        id: 1,
        firstName: 'kkdkdk',
        Role: 'admin',
        attendance: 'present',
        attendance_date: '2004-05-28',
        address: {
...
const Attendance = () => {
    ...
    const initialRecords = sampleDate.slice(0, pageSize);
    ...
    const handleSearch = () => {
        let filteredData: SampleData[] = sampleDate;

        if (formData.role !== 'Select Role' && formData.attendance_date !== '') {
            filteredData = filteredData.filter(item => item.Role === formData.role && item.attendance_date === formData.attendance_date);
    ...
    useEffect(() => {
        ...
        setRecordsData(sampleDate.slice(from, to));
    }, [page, pageSize]);
                        ...
                        <div className="flex justify-between lg:flex-row flex-col">
                            <div className=" w-full ltr:lg:mr-6 rtl:lg:ml-6 mb-6">
                                <div className="mt-4 flex gap-5  lg:flex-row flex-col">
                                    ...
                                    <input id="reciever-number" value={formData.attendance_date} type="date" name="attendance_date" onChange={handleonChange} className="form-input flex-1" placeholder="Enter Phone number"  />
                                </div>

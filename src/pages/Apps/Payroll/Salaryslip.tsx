...
const Salaryslip = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Salary slip'));
    });
    const exportTable = () => {
        window.print();
    };
    ...
    return (
        <div>
            <div className="flex items-center lg:justify-end justify-center flex-wrap gap-4 mb-6">
                ...
                <Link  className="btn btn-secondary gap-2">
                    <IconPlus />
                    Create
                </Link>

                <Link  className="btn btn-warning gap-2">
                    <IconEdit />
                    Edit
                </Link>
            </div>
            <div className="">
                <div className="flex justify-between flex-wrap gap-4 px-4">
                    <div className="text-2xl font-semibold uppercase">Payslip For the period of April 2024</div>
                    ...
                    <div className="flex justify-between sm:flex-row flex-col gap-6 lg:w-2/3">
                        <div className="xl:1/3 lg:w-2/5 sm:w-1/2">
                            <div className="flex items-center w-full justify-between mb-2">
                                <div className="text-white-dark">PAYSLIP :</div>
                                <div>#8701</div>
                            </div>
                            <div className="flex items-center w-full justify-between mb-2">
                            ...
                            <div className="flex items-center w-full justify-between mb-2">
                                <div className="text-white-dark">Department :</div>
                                <div>Library</div>
                            </div>
                            <div className="flex items-center w-full justify-between">
                                <div className="text-white-dark">Designation :</div>
                                <div>Librarian</div>
                            </div>
                        </div>
                        <div className="xl:1/3 lg:w-2/5 sm:w-1/2">

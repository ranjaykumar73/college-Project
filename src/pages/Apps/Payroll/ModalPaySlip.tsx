...
const ModalPaySlip = ({ modal5, setModal5 }) => {
    return (
        <div>
            <div>
                ...
                <Transition appear show={modal5} as={Fragment}>
                    <Dialog as="div" open={modal5} onClose={() => setModal5(false)} className="relative z-[51]">
                        <Transition.Child
                            as={Fragment}
                                ...
                                >
                                    <Dialog.Panel className="panel  my-8 w-full max-w-5xl overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                        <div className="flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]">
                                            <h5 className="text-lg font-bold">Salary Slip</h5>
                                        ...
                                        <div className="p-5">
                                            ...
                                            <Salaryslip setModal5={setModal5} />

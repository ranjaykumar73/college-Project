...
const Designation = () => {
    ...
    // useEffect(() => {
    //     setInitialRecords(() => {
    //         return department.filter((item: any) => {
    //             return (
                ...
                <div className="panel px-0 h-56 flex-1 py-6 ltr:xl:mr-6 rtl:xl:ml-6">
                    ...
                    <div className="flex justify-between flex-wrap px-4">
                        <div className="h-16  w-full">
                            <label className="ltr:mr-2 rtl:ml-2 w-28 mb-0 font-bold">Designation</label>
                    ...
                    <button type="button" onClick={handleOnSubmit} className="btn btn-primary float-end ltr:mr-4 rtl:ml-6 ltr:lg:mr-4 rtl:lg:ml-6">
                        Save
                    </button>
                </div>
                {/* list of department */}
                <div className="panel ">
                    ...
                    <div className="datatables">
                        <DataTable
                            ...
                            records={designation}
                            columns={[
                                { accessor: 'Name', sortable: false, render: ({ text }) => <div>{text}</div> },

    ...
    return (
        <div>
            <div className=" container flex xl:flex-row flex-col gap-2.5">
                <div className="panel px-0 h-60 flex-1 py-6 ltr:xl:mr-6 rtl:xl:ml-6">
                    ...
                    <button type="submit" onClick={handleOnSubmit} className="btn btn-primary float-end ltr:mr-4 rtl:ml-6 ltr:xl:mr-4 rtl:xl:ml-6">
                        Save
                    </button>
                    </div>
                </div>
